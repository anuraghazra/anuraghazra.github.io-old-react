...
const JSProjects = ({ id }) => {
  return (
    <JSProjectWrapper id={id}>
      ...
      >
        <p>
          verlet.js is a 2D Physics Simulation Engine.
          verlet.js is used for creating rapid and fast verlet physics based models and structures.
          i was developing this engine for about 4 months and made a electron based desktop drawing application on top of it.
        </p>
      </SingleJSProject>


      <SingleJSProject rowReverse
        hideNav
        title={'Atomic.js'}
        links={{
      ...
      >
        <p>
          Atomic.js is Greatly Simple 2D Physics Engine. It is a collision detection and resolution engine.
          Can be used in 2d HTML5 games and 2d physics simulations.
          it uses SAT (Seperation Axis Theorem) Collision Detection and mass seperation collision resolution.
        </p>
      </SingleJSProject>
